  ...
  if (destino == 1) {
    ...
    if (livera > 0) {
      ...
      if (manada % 2 == 0) {
        ...
        if (escolha == 1) {
          ...
          passaMinuto(20);
          statusPers();
          console.log(`Você chegou a pedra e se escondeu atrás dela. A manada acabou desviando da pedra e você ficou protegido.`);
          continuar();
        }
        passaHora(1);
        passaMinuto(30);
      ...
      if (escolha == 1) {
        ...
        if (jogada % 2 == 0) {
          passaMinuto(15);
          statusPers();
          console.log(`Você se entregou. Quando os guardas te levava para a prisão, você avistou a espada e num vacilo dos guardas, conseguiu pegá-la.`);
          continuar();
          passaHora(3);
          passaMinuto(30);
          statusPers();
    ...
    if (labuge > 0) {
      ...
      do {
        ...
        console.log(`Sem ela, será pior que procurar uma agulha em um palheiro.`);
      ...
      if (escolha == `s` || escolha == `sim`) {
        ...
        console.log(`Ninguém nunca voltou vivo pra contar se a história é verdade. Boa sorte!`);
        continuar();
        passaHora(4);
        statusPers();
      ...
      console.log(`Chupar o local da mordida e cuspir o possível veneno ou correr em busca da princesa e pedir ajuda.`);
      continuar();
      do {
        statusPers();
      ...
      if (escolha == 1) {
        ...
        console.log(`A princesa escuta seu grito de dor e corre ao seu encontro. Ao ver a picada em sua mão no chão ela diz que a Eslife não tem um veneno mortal`);
        ...
        passaHora(1);
        mostraTempo();
        console.log(`Na subida do penhasco, você se desequilibra, sem a outra mão, não consegue se segurar e acaba caindo e morrendo...`);
        gameOver();
        break;
      } else if (escolha == 2) {
        // POSSIBILIDADE DE DAR CERTO OU NÃO
        ...
        if (jogada % 2 == 0) {
          statusPers();
          console.log(`Você começa a chupar o local da mordida e cuspir. Repetidas vezes você faz isso...`);
      ...
      console.log(`A princesa lê o que está escrito na parede atrás: "Para a pedra de Labuge ter, é necessário saber o que é o mais essencial para viver"`);
      ...
      if (escolha == 1) {
        ...
        console.log(`A estátua começou a virar pó. Tudo ao redor começa a virar pó, enterrando vocês vivos!`);
        gameOver();
        break;
      } else if (escolha == 3) {
        passaMinuto(5);
        ...
        console.log(`Começam a nascer flores na estátua que se alastram por todo o lado deixando tudo bem florido.`);
        console.log(`Uma enorme flor nasce do totem e vem até você. Ao desabrochar ela revela a pedra de Labuge dentro dela.`);
        passaMinuto(5);
    ...
    if ((livera == 0 && labuge == 0) || (livera > 0 && labuge == 0) || (livera == 0 && labuge > 0)) {
      ...
      passaMinuto(20);
      console.log(`Você entra devagar caverna adentro. Você percebe que, por dentro, a caverna mais parece um castelo.`);
      ...
      console.log(`Com a pedra e Labuge, você cria uma bolha escudo ao seu redor que te protege da mordida mortal do Míssera.`);
      ...
      if (dragao.vida <= 0) {
        statusPers();
        console.log(`Você venceu o dragão Míssera! Agora a dimensão Uruzar está livre e poderá viver em paz para sempre! Obrigado!`);
        continuar();
      }
      if (personagem.vida <= 0) {
        mostraTempo();
